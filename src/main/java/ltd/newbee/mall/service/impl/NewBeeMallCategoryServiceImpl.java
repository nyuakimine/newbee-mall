...
public class NewBeeMallCategoryServiceImpl implements NewBeeMallCategoryService {
    ...
    @Override
    public List<TbSale> TbSale(Long goodsId) {
	return goodsCategoryMapper.getTbSale(goodsId);
    }

    @Override
    public List<TbCategory> TbCategory(Long categoryId) {
	return goodsCategoryMapper.getTbCategory(categoryId);
    }

    @Override
    public List<TbSale> TbsaleGoods(Long id) {
	return goodsCategoryMapper.getTbsaleGoods(id);
    }

    @Override
    public List<TbCategory> CategoryGoods(Long id) {
